/**
 * DBHelperTest.java: This class is a direct copy of DBHelper.java intended to safely test the methods found within that class
 *
...
public class DBHelperTest extends SQLiteOpenHelper
{
    ...
    public static final String DATABASE_NAME = "StatTrackerTest";
